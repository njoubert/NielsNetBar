...
enum Theme {
    ...
    /// The bar's digits: a fixed mid-grey per appearance rather than the label colour with
    /// alpha, which on a dark bar comes out nearly white. Tune the two `white:` values to taste.
